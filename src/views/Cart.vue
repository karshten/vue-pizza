                    ...
                    <div v-for="pizza in pizzas" class="cart__item">
                        <template v-if="pizza.count >= 1">
                            ...
                            <div class="cart__item-count">
                                <div @click="handleDecreasePizzaCount(pizza.id, pizza)"
                                ...
                                <b>{{pizza.count}}</b>
                                <div @click="handleIncreasePizzaCount(pizza.id, pizza)"
                ...
                <div class="cart__bottom">
                    ...
                    <div class="cart__bottom-buttons">
                        <a href="/" class="button button--outline button--add go-back-btn">
                            ...
                            <router-link :to="'/'"><span>Вернуться назад</span></router-link>
                        </a>
