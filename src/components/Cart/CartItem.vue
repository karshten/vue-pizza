    ...
    <div class="cart__item">
        <template v-if="pizza.count >= 1">
            ...
            <div class="cart__item-count">
                <div @click="handleDecreasePizzaCount()"
                ...
                <b>{{pizza.count}}</b>
                <div @click="handleIncreasePizzaCount()"
...
<script>
    ...
    export default {
        ...
        setup(props, context) {
            ...
            const handleIncreasePizzaCount = () => {
                store.commit('INCREMENT_PIZZA_COUNT', props.pizza)
            }

            const handleDecreasePizzaCount = () => {
                store.commit('DECREMENT_PIZZA_COUNT', props.pizza)
            }

            const handleDeletePizza = () => {
                store.commit('DELETE_PIZZA_FROM_CART', props.pizza)
            }
            return {handleIncreasePizzaCount, handleDecreasePizzaCount, handleDeletePizza}
        }
    }
</script>
